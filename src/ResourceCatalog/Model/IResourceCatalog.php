...
'SHTTDJXX'=>10,
    ...
    const USERGROUP_TYPE_RELATIONSHIP = array(
        ...
        IUserGroup::ID['XLGLMFZHGGWYH'] => array(self::TYPE['HMDZRR'],self::TYPE['HMDFR'],self::TYPE['HEIMDZRR'],self::TYPE['HEIMDFR'],self::TYPE['ZDRQXX']),
        ...
        IUserGroup::ID['XLGLMSFJ'] => array(self::TYPE['ZDRQXX']),
